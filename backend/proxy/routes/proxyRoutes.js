...
const SERVICE_TARGETS = {
  api: process.env.API_SERVER_URL || 'http://api:4001',
  documents: process.env.DOCUMENTS_SERVER_URL || 'http://documents:4002',
  auth: process.env.API_SERVER_URL || 'http://api:4001' // Auth è parte dell'API server
};
