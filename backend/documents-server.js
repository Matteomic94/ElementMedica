...
app.get('/download/:filename', 
  ...
  try {
    ...
    try {
      ...
      if (!attestato) {
        logAudit('document_access_denied', userId, filename, {
          userCompanyId,
      ...
      logAudit('document_downloaded', userId, filename, {
        userCompanyId,
...
app.post('/upload-template', 
  ...
  try {
    ...
    if (!allowedTypes.includes(fileExtension)) {
      logAudit('template_upload_rejected', userId, filename, {
        userCompanyId,
    ...
    logAudit('template_uploaded', userId, filename, {
      userCompanyId,
      fileSize: req.file.size,
    ...
    logger.info('Template uploaded successfully', { service: 'documents-server', filename, userId, companyId: userCompanyId });
...
app.get('/templates', 
  ...
  try {
    ...
    logAudit('templates_listed', userId, 'templates', {
      userCompanyId,
...
app.get('/attestati', 
  ...
  try {
    ...
    logAudit('attestati_listed', userId, 'attestati', {
      userCompanyId,
