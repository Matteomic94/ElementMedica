...
async function testLoginAndVerify() {
  console.log('🧪 Test Login e Verify dopo riavvio server');
  ...
  try {
    ...
    console.log('Token ricevuto:', loginResponse.data.accessToken ? 'SÌ' : 'NO');
    ...
    console.log('Token ricevuto:', proxyLoginResponse.data.accessToken ? 'SÌ' : 'NO');
    ...
    console.log('✅ Proxy routing funziona correttamente');
